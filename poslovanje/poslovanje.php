              ...
              <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingOne">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion1" href="#collapse-<?php echo $rowNoviProblemi["idProblema"];?>" aria-expanded="true" aria-controls="collapse-<?php echo $rowNoviProblemi["idProblema"];?>">
     ...
     while($rowNerjeseniProblemi=mysql_fetch_array($resultNerjeseniProblemi)){
        ?>
              ...
              <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingOne">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion2" href="#collapse-<?php echo $rowNerjeseniProblemi["idProblema"];?>" aria-expanded="true" aria-controls="collapse-<?php echo $rowNerjeseniProblemi["idProblema"];?>">
                      <?php echo $rowNerjeseniProblemi["naslov"];?>
                    </a>
                  </h4>
                </div>
                  <div id="collapse-<?php echo $rowNerjeseniProblemi["idProblema"];?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                  <div class="panel-body">
                    <?php
                      ...
                      ?>
                      <br/><br/>
                     <button type="button" class="btn btn-primary btn-md" onClick="problemi(2,<?php echo $rowNerjeseniProblemi["idProblema"];?>);">Rješeno</button>
                  </div>
                </div>
              </div>
